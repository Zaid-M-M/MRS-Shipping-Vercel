    ...
    const sendEmailCr = async (e) => {
        ...
        if (name_fld_cr == '') {
            ...
            return false;
                ...
                fetch('https://script.google.com/macros/s/AKfycbz-1hyxx1HlednwMz-1VirzczXDIT7-Wi3JaQ9D4tZI6hu0qt6GxOD589B5Ugyud6gLuQ/exec', {
                    method: 'POST',
                ...
                emailjs.sendForm('service_r922cxj', 'template_bza8r36', e.target, 'SsPYHKCapw4h-xBn_')
                    .then((result) => {
                ...
                <div className="main-container width-1200 white">
                    ...
                    <div className='row apply-nw-rw'>
                        <div className='clm-2 contnt-clm'>
                            ...
                            <p data-aos="fade-in" data-aos-duration="500" data-aos-delay="400" data-aos-once="true">Embark on your career adventure with us: Fill out the application below.</p>
                        </div>

                        <div className='clm-2'>
                            <div className='contact_form'>
                                <form className="conversion_form" ref={form_career} onSubmit={sendEmailCr} id='career_form_bx' data-aos="fade-in" data-aos-duration="500" data-aos-delay="400" data-aos-once="true">

                                    <input className='page_name' type='hidden' name='Page_name' value='Careers Page' />
                                    ...
                                    <div className="conv_frm_spc">
                                        ...
                                        <input type="text" name='name' className="form-control" placeholder="Name" id='name_fld_cr' ref={nameinput_cr} onFocus={handleFocus_cr} />
                                        <p className='error_msg' id='nm_err'>Please Enter Name</p>
                                        <p className='error_msg' id='nm_err1'>Letters and space only.</p>
                                    </div>
                                    <div className="conv_frm_spc">
                                        <label className="form-label">Email Address</label>
                                        <input type="email" name='email' className="form-control" placeholder="Email"  id='email_fld_cr' ref={emailinput_cr} onFocus={handleFocus_cr} />
                                    ...
                                    <div className="conv_frm_spc">
                                        ...
                                        <input type="text" name='experience' className="form-control" placeholder="Experience"  id='org_fld_cr' ref={orginput_cr} onFocus={handleFocus_cr} />
                                        <p className='error_msg' id='cmp_err'>Please Enter Experience</p>
                                    </div>
                                    <div className="conv_frm_spc">
                                        <label className="form-label">Phone No</label>
                                        <input type="number" name='phone' className="form-control" placeholder="Phone"  id='phone_fld_cr' ref={phoneinput_cr} onFocus={handleFocus_cr1} />
                                    ...
                                    <div className='conv_frm_spc'>
                                                <div className='frm_inr_dv'>
                                                    ...
                                                    <input type="file" placeholder="Attach CV" id="myFile" name="cv" ref={fileinput} onFocus={handleFocus_cr}></input>
