                ...
                <div className="main-container width-1200 white">
                    ...
                    <div className='row'>
                        <div className='clm-2 contnt-clm'>
                            ...
                            <p data-aos="fade-in" data-aos-duration="500" data-aos-delay="400" data-aos-once="true"> We’re always happy to hear from potential customers, partners, and collaborators.</p>
                        </div>

                        <div className='clm-2'>
                            <div className='contact_form'>
                                <form className="conversion_form" ref={form} onSubmit={sendEmail} id='enq_form_bx' data-aos="fade-in" data-aos-duration="500" data-aos-delay="400" data-aos-once="true">
                                    ...
                                    <div className="conv_frm_spc">
                                        ...
                                        <input type="text" name='name' className="form-control" placeholder="Name" id='name_fld' ref={nameinput} onFocus={handleFocus} />
                                        <p className='error_msg' id='nm_err'>Please Enter Name</p>
                                        <p className='error_msg' id='nm_err1'>Letters and space only.</p>
                                    </div>
                                    <div className="conv_frm_spc">
                                        <label className="form-label">Email Address</label>
                                        <input type="email" name='email' className="form-control" placeholder="Email"  id='email_fld' ref={emailinput} onFocus={handleFocus} />
                                    ...
                                    <div className="conv_frm_spc">
                                        ...
                                        <input type="text" name='organisation' className="form-control" placeholder="Organisation"  id='org_fld' ref={orginput} onFocus={handleFocus} />
                                        <p className='error_msg' id='cmp_err'>Please Enter Organisation</p>
                                    </div>
                                    <div className="conv_frm_spc">
                                        <label className="form-label">Phone No</label>
                                        <input type="number" name='phone' className="form-control" placeholder="Phone"  id='phone_fld' ref={phoneinput} onFocus={handleFocus1} />
                                    ...
                                    <div className="col-6 conv_frm_spc tell_sec">
                                        ...
                                        <textarea className="form-control" name='message' id='msg_fld' placeholder="" ref={msginput} onFocus={handleFocus} rows="4" cols="50"></textarea>
                                    ...
                                    <p className='thnk txt_wht white' id='thnk_box'>Your form has been sent successfully</p>
                            </div>
                        </div>
                    </div>
