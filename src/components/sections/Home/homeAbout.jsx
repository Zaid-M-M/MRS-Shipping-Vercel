            ...
            <div className="section section-padd-LR hm-abt-sec">
                <div className="main-container width-1100 flex" data-aos="fade-in" data-aos-duration="500" data-aos-once="true">                
                    ...
                    <div className="clm-2">                        
                        ...
                        <a href="/about" className="blue hm-abt-btn btn" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="0">Learn more about MRS Offerings <img src={blue_Arrow} alt="Arrow" /> </a>      
