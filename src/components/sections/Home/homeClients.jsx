                    ...
                    <div className="client-img-bx">
                        ...
                        <div className="client-contnt-bx">
                            <div className="swiper3 cta-sldr">
                                        <div className="swiper-wrapper">
                                            <div className="swiper-slide">
                                                <h2 className="white ttl-60px">MRS is the 1st Logistics Company in Kutch to use RFID & blck Chain technology for Real time visibilty for last Mile Delivery</h2>                  
                                            </div>
                                            <div className="swiper-slide">
                            ...
                            <div className="client-btn enquire_btn" data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="600">
                                    <a>Elevate Your<br/>Supply Chain Today <img src={CTA_ARROW} alt="Arrow" className="hm-cta"/></a>
                            </div>
