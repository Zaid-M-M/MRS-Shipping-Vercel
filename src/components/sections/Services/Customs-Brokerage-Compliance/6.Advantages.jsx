    ...
    return (
        ...
        <div className="compliance-sec section-padd-LR overflow">
            <div className="main-container width-1200 white built-to-suit-container1">     
                <h3 className='we-offer-txt advtg-txt js-split-text orange'>Advantages of Multi-user Warehousing:</h3>
                ...
                <p className='mob-mrgin-btm-o complieance-Advbottom-para' data-aos="fade-in" data-aos-duration="500" data-aos-once="true" data-aos-delay="900">Choose MRS multi-user warehousing to unlock a world of efficiency, flexibility, and cost-effectiveness for your supply chain. Experience shared success in warehousing that adapts to your every requirement.</p>      
            </div>
        </div>
