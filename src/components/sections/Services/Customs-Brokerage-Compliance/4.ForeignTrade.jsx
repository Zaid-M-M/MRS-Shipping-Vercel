        ...
        <div className="section-padd-LR overflow grey-bg" id='foreign'>
            <div className="main-container width-1200 built-to-suit-container1 black">  
                ...
                <div className='row built-row customs-row'>
                    ...
                    <div className='clm-2'>   
                        <p className='ttl-25px trade-para' data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="1000">MRS's depth of knowledge in Foreign Trade compliance like Free Trade Agreements and its compliance, Export and Import benefits, Duty free import license like EPCG, Advance Authorization, MOOWR scheme etc is unmatched. Our team stays abreast of the ever-changing regulations, ensuring that your business is not only compliant but also protected from potential non compliance ,penalties and delays. We understand the intricacies of foreign trade laws and utilize this expertise to facilitate smooth and lawful international trade for our clients.</p>
                    </div>                    
                </div>                             
            </div>
        </div>
