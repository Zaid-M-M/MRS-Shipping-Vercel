        ...
        <div className="service-spotlight custom-brokerage-sec section inner-spotlight-sec section-padd-LR overflow" id='brown-bg'>
            <div className="main-container width-1250 flex">
                <div className="inner-spot-clm-1 servcs-spot-clm1">
                    <h1 className="js-split-text white">Pioneering Duty-Free<br />Warehousing Solutions</h1>
                    ...
                    <p className="white" data-aos="fade-up" data-aos-duration="900" data-aos-once="true" data-aos-delay="500">Facilitating Global Trade with Strategic Warehousing  Solution</p>
            ...
            <div className="inner-img-sec">                
                <div className="inner-spot-clm-2">                    
                    <img src={Pioneering_spot} alt="Pioneering_spot" className='lToR' data-aos="fade-in" data-aos-duration="800" data-aos-once="true" data-aos-delay="600"/>                    
                </div>
            </div>
