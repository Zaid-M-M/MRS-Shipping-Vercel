                ...
                <div className='row built-row'>
                    ...
                    <div className='clm-2 built-cntnt-clm white'>   
                        ...
                        <div className='bond-moretext'>
                            <p>Our expansive network encompasses ten strategically positioned warehouses in close proximity to pivotal sea ports such as Hazira, Kandla, and Mundra. Additionally, we proudly operate a Free Trade Warehousing Zone in Mundra, delivering an extensive warehousing expanse totaling 5 Lakh Sq Ft. MRS Customs Bonded Warehousing is your key to a fortified supply chain, where customs compliance seamlessly aligns with secure storage, ensuring the utmost efficiency for your business.</p>                         
                        </div>
                ...
                <div className='row built-row'>
                    ...
                    <ul className="accordion-list white" data-aos="fade-in" data-aos-duration="500" data-aos-once="true" data-aos-delay="1000">
                        ...
                        <li>
                            ...
                            <div className="answer">
                                <p>By choosing MRS Customs Bonded Warehousing, you enjoy cost-effective storage solutions, (eliminating the need for separate ISO container rentals).</p>
                            </div>
                        </li>
                        <li>
                            <h3>Tax Benefits</h3>
