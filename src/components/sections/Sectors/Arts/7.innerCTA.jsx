                    ...
                    <div className="client-img-bx global-cta" data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">
                        ...
                        <div className="client-contnt-bx">
                            <h2 className="white ttl-60px" data-aos="fade-in" data-aos-duration="500" data-aos-once="true" data-aos-delay="600" >We are the 1st Company in Kutch to Provide Single Largest Warehouse of Grade <span className="bold">A</span> category</h2>
                                <div className="client-btn inner-cta-btn enquire_btn" data-aos="fade-up" data-aos-duration="800" data-aos-once="true" data-aos-delay="600">
                                    <a>Elevate Your Supply Chain Today <img src={white_Arrow} alt="Arrow" className="inner-cta-img"/></a>
                                </div>
