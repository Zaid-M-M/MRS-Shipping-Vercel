            ...
            <div className="main-container width-1250 built-to-suit-container1">     
                ...
                <div className='row built-row T-B-Padding B-padding-o '>
                    <div className='clm-2 solution-clm'>   
                        <h3 data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Liquid/Dry Bulk and Break-Bulk Cargo</h3>
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Tailored logistics solutions for the transportation of bulk materials, from liquids to granular products, essential for these industries.</p>
                        <h3 data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Duty-Free Warehousing</h3>
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Strategic warehousing solutions near major transportation hubs, facilitating the seamless movement of bulk goods in international trade.</p>                    
                    </div>
