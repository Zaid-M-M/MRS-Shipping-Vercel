            ...
            <div className="main-container width-1250 built-to-suit-container1">     
                ...
                <div className='row built-row T-B-Padding B-padding-o '>
                    <div className='clm-2 solution-clm'>   
                        ...
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Navigating the intricate web of customs and international trade regulations is critical for these sectors, and MRS provides the expertise needed to ensure seamless operations.</p>
                        <h3 data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Tech-Driven Last-Mile Delivery</h3>
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Advanced delivery services tailored to the needs of fast-paced manufacturing and consumer goods sectors, enhancing supply chain efficiency.</p> 
                        <h3 data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Duty-Free Warehousing</h3>
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="900">Strategic warehousing solutions that complement the manufacturing process, from raw materials storage to finished goods distribution, ensuring a smooth supply chain flow.</p>                    
                    </div>

                    <div className='clm-2 built-img-clm'>
                        <img src={MultiuserWarehousing} alt='MultiuserWarehousing' data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="1000"/>
                    </div>
                </div>     
