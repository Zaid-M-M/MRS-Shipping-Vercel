...
export default function Header2() {
    ...
    const sendEmail1 = async (e) => {
        ...
        if (name_fld_popup == '') {
            ...
            er55.className += " show_error";
                ...
                fetch('https://script.google.com/macros/s/AKfycbwOP9_uQMoUzUQMbgzEzHir-fhe5FLJACsEfhFfWGxhXnpmfZTvZF-5lcFLuFRMeUni/exec', {
                    method: 'POST',
                ...
                emailjs.sendForm('service_r922cxj', 'template_u6s227l', e.target, 'SsPYHKCapw4h-xBn_')
                    .then((result) => {
  ...
  return (
    <>
    {/*------------------------------------------------------------------------------------- Desktop header*/}
        <div className='header_sec snap_sec desktop_header1' id='desk_header_1' data-aos="fade-in" data-aos-delay="400" data-aos-once="true">
                            ...
                            <div className="container-fluid no_padding">
                                ...
                                <div className="collapse navbar-collapse" id="main_nav">
                                    <ul className="navbar-nav">
                                        ...
                                        <li className="nav-item menu_link no_LR_margin contact_link"><a className="nav-link" href="/about"> About Us </a></li>                                      

                                        <li className="nav-item dropdown has-megamenu menu_link explore_drp">
                                            <a className="nav-link dropdown-toggle " href="#" data-bs-toggle="dropdown" data-bs-hover="dropdown"> Services</a>
                                                ...
                                                <div className="row_border">
                                                    ...
                                                    <div className="over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx1">
                                                            <h5>End-to-End Supply Chain<br />Management</h5>
                                                            <ul className="list-unstyled">
                                                                <li><a href="/services/multiuser-warehousing">Warehousing Solutions</a></li>
                                                                <li><a href="/services/pioneering-duty-free-warehousing-solutions">Free Trade Zone, Mundra SEZ</a></li>
                                                                <li><a href="/services/road-and-rail-transport">Surface & Rail Transport</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div className="over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx2">
                                                            <h5>Regulatory Compliance and<br /> Documentation</h5>
                                                            <ul className="list-unstyled">
                                                            <li><a href="/services/customs-brokerage-and-regulatory-compliance">Customs Brokerage</a></li>
                                                            <li><a href="/services/customs-brokerage-and-regulatory-compliance#foreign">Customs & Foreign Trade Compliance</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx3">
                                                            <h5>Innovative Logistics and<br /> Industrial Solutions</h5>
                                                            <ul className="list-unstyled">
                                                                <li><a href="/services/tech-driven-last-mile-delivery-services">Tech-Driven Last-Mile Delivery</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <li className="nav-item dropdown has-megamenu menu_link esg_drp">
                                            <a className="nav-link dropdown-toggle " href="#" data-bs-toggle="dropdown" data-bs-hover="dropdown"> Sectors  </a>
                                            <div className="dropdown-menu megamenu" role="menu">
                                                <div className="row_border esg_menus">
                                                    ...
                                                    <div className="over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx1">
                                                            <ul className="list-unstyled">
                                                                <li><a href="/sector/arts-exhibitions-and-luxury-Goods">Arts, Exhibitions, and Luxury Goods</a></li>
                                                                <li><a href="/sector/industrial-sector">Industrial Sector</a></li>
                                                    ...
                                                    <div className="over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx2">
                                                            <ul className="list-unstyled">
                                                                <li><a href="/sector/chemicals-construction-energy-and-agriculture">Chemicals, Construction, Energy, and Agriculture</a></li>
                                                                <li><a href="/sector/e-commerce-and-retail">E-commerce and Retail</a></li>
                                                            </ul>
                                                        </div>  
                                                    </div>
                                                    <div className="over_flow">
                                                        <div className="col-megamenu menu_animate_box animi_bx3">
                                                            <ul className="list-unstyled">
                                                            <li><a href="/sector/renewable-energy-and-infrastructure-projects">Renewable Energy and Infrastructure Projects</a></li>
                                                            </ul>
                                                        </div>  
                                                    </div>    
                                        ...
                                        <li className="nav-item menu_link no_LR_margin contact_link"><a className="nav-link" href="/careers"> Career </a></li>

                                        <li className="nav-item menu_link no_LR_margin contact_link"><a className="nav-link" href="/blogs"> Blog </a></li>
                                    
                                        <li className="nav-item menu_link no_LR_margin contact_link"><a className="nav-link" href="/contact-us"> Contact Us </a></li>
                    ...
                    <div className ="clm-2 mob-clm2">                
                        <nav role="navigation">
                            ...
                            <ul id="menu">
                                ...
                                <li className="has-children"><a>Services <img src={Sub_menu} className="icon-arrow"/></a>
                                        <ul className="children">
                                            <li><a href="/services/multiuser-warehousing">Multiuser Warehousing</a></li>
                                            <li><a href="/services/road-and-rail-transport">Road & Rail Transport</a></li>                                      
                                            <li><a href="/services/pioneering-duty-free-warehousing-solutions">Pioneering Duty-Free Warehousing Solutions</a></li>
                                            <li><a href="/services/customs-brokerage-and-regulatory-compliance">Customs Brokerage and Regulatory Compliance</a></li>
                                            <li><a href="/services/tech-driven-last-mile-delivery-services">Tech-Driven Last-Mile Delivery Services</a></li>
                                        </ul>   
                                </li> 
                                <li className="has-children"><a>Sector <img src={Sub_menu} className="icon-arrow"/></a>
                                        <ul className="children">
                                            <li><a href="/sector/arts-exhibitions-and-luxury-Goods">Arts, Exhibitions, and Luxury Goods</a></li>
                                            <li><a href="/sector/industrial-sector">Industrial Sector</a></li>                                      
                                            <li><a href="/sector/e-commerce-and-retail">E-commerce and Retail</a></li>
        ...
        <div className='career_popup_box' data-aos="fade-in" data-aos-delay="400" data-aos-once="true">
            <img className='career_cls_btn' src={Close_icon} ></img>

            <div className='caeer_inner_dv'>
                <h2 className='career_hd'>Join us</h2>

                <form className="conversion_form" ref={form_popup} onSubmit={sendEmail1} id='popup_form_bx' data-aos="fade-in" data-aos-duration="500" data-aos-delay="400" data-aos-once="true">
                                    ...
                                    <div className="conv_frm_spc">
                                        ...
                                        <input type="text" name='name' className="form-control" placeholder="Name" id='name_fld_popup' ref={nameinput_popup} onFocus={handleFocus_pp} />
                                        <p className='error_msg' id='nm_errP'>Please Enter Name</p>
                                        <p className='error_msg' id='nm_errP1'>Letters and space only.</p>
                                    </div>
                                    <div className="conv_frm_spc">
                                        <label className="form-label">Email Address</label>
                                        <input type="email" name='email' className="form-control" placeholder="Email"  id='email_fld_popup' ref={emailinput_popup} onFocus={handleFocus_pp} />
                                        <p className='error_msg' id='eml_errP'>Please Enter Email Address</p>
                                        <p className='error_msg' id='eml_errP1'>Please Enter Valid Email Address</p>
                                    </div>
                                    {/* <div className="conv_frm_spc">
                                    ...
                                    <div className="conv_frm_spc">
                                        ...
                                        <input type="number" name='phone' className="form-control" placeholder="Phone"  id='phone_fld_popup' ref={phoneinput_popup} onFocus={handleFocus_pp1} />
                                        <p className='error_msg' id='phn_errP'>Please Enter Phone No</p>
                                        <p className='error_msg' id='phn_errP1'>Please Enter Valid Phone No</p>
                                    </div>

                                    <div className='conv_frm_spc selectin-fld'>
                                        <label className="form-label">Type of Enquiry</label>
                                        <select className='form-control enq_type cont_enq' name='enquiry' id='dprt_fld_popup' ref={departinput_popup} onFocus={handleFocus_pp}  >
                                            <option value="" disabled selected>You are interrested in</option>
                                            <option value="Built To Suit Warehousing">End-to-End Supply Chain Management</option>
                                            <option value="Multiuser Warehousing">Regulatory Compliance and Documentation</option>
                                            <option value="Customs Bonded Warehouse">Innovative Logistics and Industrial Solutions</option>
                                        </select>
                                        <p className='error_msg' id='depart_errP'>Please Select Type of Enquiry</p>
                                    </div>
                                    ...
                                    <p className='thnk txt_wht white' id='thnk_boxP'>Your form has been sent successfully</p>
