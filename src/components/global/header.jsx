    ...
    useEffect(() => { 
        ...
        (function () {
          $('.has-children').off('click').on ('click', function() {
            ...
            $(function() {
                $('.sector-sub-menu').mouseenter(function() {
          ...
          $(function() {
            $('.servc-sub-menu').mouseenter(function() {
                    ...
                    <div className="clm-2 hdr-clm2">
                        <div className="head-links">
                            ...
                            <div className="has-sub-menu">
                                <a href="#" className="servc-lnk">Service</a>
                                    <ul className="sub-menu servc-sub-menu">
                                        <div className="sub-menu-innr">
                                            <li className="list-one">End-to-End Supply Chain<br />Management
                                            ...
                                            <li className="list-two">Regulatory Compliance and<br /> Documentation 
                                            ...
                                            <li className="list-three">Innovative Logistics and<br /> Industrial Solutions
                            ...
                            {/* <a href="#">Sectors</a> */}
                            <div className="has-sub-menu">
                                <a href="#" className="sectr-lnk">Sectors</a>
                                    <ul className="sub-menu sector-sub-menu">
                                        <div className="sub-menu-innr ">
                                            ...
                                            <li><a href="/sector/manufacturing-automotive-technology-and-consumer-goods">Manufacturing, Automotive, Technology, and Consumer Goods</a></li>
                                        </div>
                                    </ul>
                            </div>
